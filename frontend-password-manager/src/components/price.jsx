      ...
      <section className="min-h-screen flex items-center justify-center pt-16">
        <div className="w-full max-w-6xl rounded-xl p-12">
          ...
          <div className=" flex flex-wrap justify-center gap-8">
            {/* Basic Plan */}
            <div className="w-full md:w-1/3 lg:w-1/4 bg-white rounded-lg p-8 outline: none">
              <h3 className="text-2xl font-semibold text-center text-gray-800">
                Basic Plan
              </h3>
              <p className="text-center text-gray-600 my-4">Free</p>
              ...
              <button className="w-full bg-[#AA7DFF] text-white py-2 rounded-lg hover:bg-[#C49DFF] transition-colors duration-300">
                Choose Plan
              </button>
            </div>
            ...
            <div className="w-full md:w-1/3 lg:w-1/4 bg-white rounded-lg p-8 outline: none">
              ...
              <ul className="text-gray-600 mb-6">
                ...
                <li className="flex items-center mb-2">
                  <span className="mr-2 text-green-500">✔</span> Unlimited Passwords
                </li>
                <li className="flex items-center mb-2">
