          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 mt-4">
            ...
            <div className="bg-white bg-opacity-80 shadow-lg rounded-lg p-4 md:p-6 w-full md:w-64 text-left">
              ...
              <p className="text-sm md:text-md">
                Total Users: <span className="font-bold">10</span>
              </p>
              <p className="text-sm md:text-md">
                User Left: <span className="font-bold">0</span>
              </p>
              <button
                onClick={() => {
                  navigate("/user/addpassword");
                }}
                className="bg-[#AA7DFF] rounded-xl text-white py-2 px-2 mt-2 hover:scale-105 hover:bg-[#C49DFF] transition-transform duration-300"
              >
                Add Password
              </button>
            </div>
            ...
            <div className="bg-white bg-opacity-80 shadow-lg rounded-lg p-4 md:p-6 w-full md:w-64 text-left">
              ...
              <p className="text-sm md:text-md">
                Special Key: <span className="font-bold">Updated Done</span>
              </p>
              <p className="text-sm md:text-md">
                Algorithm Used: <span className="font-bold">RSA</span>
              </p>
              <button
                onClick={() => {
                  navigate("/user/info");
