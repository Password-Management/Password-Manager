  ...
  return (
    <>
      <div class="w-screen  flex items-center justify-center h-screen">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 h-1/2">
          <div class="max-w-md">
            ...
            <button
              onClick={handlClick}
              className="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-[#AA7DFF] active:bg-[#AA7DFF] hover:bg-[#C49DFF]"
            >
              Back to homepage
            </button>
          </div>
