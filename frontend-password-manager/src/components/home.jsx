        ...
        <div className="container flex flex-col-reverse lg:flex-row items-center gap-10">
          <div className="flex flex-1 flex-col items-center lg:items-start">
            ...
            <p className="text-gray-600 text-lg text-center lg:text-left mb-6">
              At KeyPass, we prioritize your data security above all else.
              Leveraging advanced RSA encryption alongside cutting-edge ASA
              technology, we ensure your passwords are safeguarded with the
              highest level of protection. Trust us to keep your sensitive
              information secure.
            </p>
